      ...
      <div class="pl15 pr50">
       ...
       @endif
        ...
        <div class="center-block mw800">
          ...
          <form method="post" action="{{ route('picture.update', ['id' => $picture->id]) }}" id="form-ui" enctype="multipart/form-data">
          ...
          {{ csrf_field() }}
                ...
                <div class="row">
                  <div class="col-md-8">
                    <div class="section">
                      <label class="field">
                        <input type="text" name="url" id="url" class="gui-input" placeholder="Url" value="{{ $picture->url }}">
                      </label>
                    </div>
                  </div>
                  <div class="col-md-4">
                ...
                <div class="row">
                  <div class="col-md-5">
                    <div class="section">
                      <label class="field">
                        <input type="text" name="alias" id="alias" class="gui-input" placeholder="Alias" value="{{ $picture->alias }}">
                      </label>
                    </div>
                  </div>
                </div>
